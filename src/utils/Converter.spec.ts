...
describe('Converter.cloneObjec', () => {
  ...
  it('Returns number if object to clone is a number', () => {
    let test: number = 1;
    let result = Converter.cloneObject(test); 
  ...
  it('Returns Date if object to clone is a Date', () => {
    ...
    let result = Converter.cloneObject<Date>(test); 
  ...
  it('Returns FakeObject if object to clone is a FakeObject', () => {
    let test = new FakeObject(1, 2);
    test.p3 = {a: 1, b: 'pota'};
    let result = Converter.cloneObject<FakeObject>(test); 
